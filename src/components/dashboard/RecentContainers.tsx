  ...
  return (
    <Card className="h-auto">
      ...
      {containers.length === 0 ? (
        ...
        <div className="overflow-x-auto -mx-3.5 sm:-mx-5 px-3.5 sm:px-5">
          <table className="w-full text-left border-collapse table-fixed min-w-[680px]">
            {/* Optimized column proportions: ID 14%, Name 25%, Image 28%, Status 19%, Actions 14% */}
            <colgroup>
              <col className="w-[14%]" />
              <col className="w-[25%]" />
              <col className="w-[28%]" />
            ...
            <thead className="text-[10px] sm:text-[11px] uppercase tracking-wider text-zinc-400 font-mono border-b border-zinc-800 bg-zinc-950/40 select-none">
              <tr className="h-9">
                <th className="py-2 px-3 font-medium">Container ID</th>
            ...
            <tbody className="divide-y divide-zinc-800/40">
              {displayedContainers.map((container) => {
                ...
                return (
                  ...
                  >
                    {/* 1. Container ID */}
                    <td className="py-2.5 px-3 text-zinc-400 font-mono text-[11px] whitespace-nowrap align-middle">
                    ...
                    <td className="py-2.5 px-3 font-medium text-zinc-100 text-xs sm:text-[13px] truncate whitespace-nowrap align-middle" title={container.name}>
                      <span className="truncate block font-mono text-zinc-100 font-semibold">
                        {container.name || '-'}
                      </span>
                    </td>
                    ...
                    <td className="py-2.5 px-3 align-middle truncate whitespace-nowrap">
                      <TagBadge tag={container.image} maxWidth="max-w-[140px] sm:max-w-[170px]" />
                    </td>
                    ...
                    {/* 5. Actions: Unified group with 30px height */}
                      ...
                      <div className="inline-flex items-center gap-1.5 justify-end">
                        ...
                        {isUp ? (
                          <button
                            ...
                            className={`h-[30px] inline-flex items-center gap-1 px-2.5 rounded-md text-[11px] font-medium transition-colors border cursor-pointer ${
                              isStopping && stoppingContainerId === container.container_id
                        ...
                        <button
                          ...
                          disabled={isMutatingThis}
                          className={`w-[30px] h-[30px] inline-flex items-center justify-center rounded-md text-zinc-400 hover:text-zinc-200 hover:bg-zinc-800 bg-zinc-900/60 border border-zinc-800 hover:border-zinc-700 transition-colors cursor-pointer ${
                            isRestarting && restartingContainerId === container.container_id
                        ...
                        <button
                          ...
                          className="w-[30px] h-[30px] inline-flex items-center justify-center rounded-md text-zinc-400 hover:text-blue-400 hover:bg-zinc-800 bg-zinc-900/60 border border-zinc-800 hover:border-zinc-700 transition-colors cursor-pointer"
